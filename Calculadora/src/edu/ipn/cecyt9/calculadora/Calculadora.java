 ...
 * 
 * @author:  Alonso Olmos Marco Antonio
 * group: 5IM8
 * @version:  1.0 
 * @date: 06-09-2015 
 */
public class Calculadora extends JFrame {
	...
	public Calculadora() {
		...
		pantalla.setEditable(false);
                pantalla.setBackground(new java.awt.Color(234,236,186));	
		panel.add("North", pantalla);

		panelNumeros = new JPanel();
		panelNumeros.setLayout(new GridLayout(4 , 3));
                panelNumeros.setBackground(new java.awt.Color(141,253,205));
		...
		panelOperaciones.setLayout(new GridLayout(4, 3));
                panelOperaciones.setBackground(new java.awt.Color(141,253,205));
